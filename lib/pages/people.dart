                      ...
                      child: SingleChildScrollView(
                        child: Column(
                          children: [
                            ...
                            ...closeFriends
                                .map((f) => FriendCard(friend: f, onStarTap: () => _toggleFavorite(f)))
                                .toList(),
...
class FriendCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: const Color(0xFFF6F6F6), // ✅ 카드 배경 F6F6F6
        borderRadius: BorderRadius.circular(12),
      ),
      child: Row(
        children: [
          ...
          Container(
            ...
            decoration: const BoxDecoration(
              color: Color(0xFF383C59), // 네이비 배경
              shape: BoxShape.circle,
            ),
            child: Center(
              child: Image.asset(
                friend.imagePath, // 예: assets/images/chick_g1.png
                width: 50, // 48 원 안에서 잘 맞는 크기
                height: 50,
                fit: BoxFit.contain,
              ),
            ),
